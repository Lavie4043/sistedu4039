<?php
    ...
    include('../../app/controllers/kardexestudiante/listado_de_kardexs.php');
        ...
        <div class="row">
          <div class="col-md-12">
           ...
           <table class="table table-hover table-dark table-bordered table-sm">
                ...
                <?php
                $contador = 0;
                foreach ($asignacionesalumnos as $asignacionalumno){
                    $id_grado = $asignacionalumno['id_grado'];
                    if($email_sesion == $asignacionalumno['email']){ 
                        $id_asignacionalumno = $asignacionalumno['id_asignacionprece'];
