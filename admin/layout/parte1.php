      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="<?=APP_URL;?>/admin/preceptores" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listado de Preceptores</p>
                </a>
                </li>
            </ul>
            <ul class="nav nav-treeview">      
                  <li class="nav-item">
                <a href="<?=APP_URL;?>/admin/preceptores/asignacion.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Asignaciones preceptores</p>
                </a>
              </li>
